...
var ObsidianClipperPlugin = class extends import_obsidian5.Plugin {
  ...
  handleSubjectBookmarkletCommand(filePath, fileName, updateRequired = false) {
    let noticeText = "";
    if (updateRequired) {
    ...
    const bm = new BookmarketlGenerator(this.app.vault.getName(), filePath, this.settings.markdownSettings).generateBookmarklet();
    ...
    bookmarkletLinkModal.contentEl.append(createEl("a", {
      href: bm,
  ...
  handleCopyBookmarkletCommand(updateRequired = false) {
    ...
    const bm = new BookmarketlGenerator(this.app.vault.getName(), "", this.settings.markdownSettings).generateBookmarklet();
    const bookmarkletLinkModal = new import_obsidian5.Modal(this.app);
    bookmarkletLinkModal.titleEl.createEl("h2", {
